...
export default function GalaxyPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-[1200px] mx-auto space-y-4">
      <header>
        <h1 className="text-2xl font-semibold font-[family-name:var(--font-heading)]">Galaxie</h1>
        <p className="text-sm text-text-muted mt-1">Tout ton patrimoine — portefeuilles, actifs, objectifs et flux.</p>
      </header>
      {error && (
